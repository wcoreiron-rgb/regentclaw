    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          {[
            { label: 'Total',    val: stats?.total_findings ?? '—',  c: 'text-sky-400 bg-sky-900/20 border-sky-800' },
            { label: 'Critical', val: stats?.by_severity?.critical ?? '—', c: 'text-red-400 bg-red-900/20 border-red-800' },
            { label: 'Open',     val: stats?.open_count ?? '—',      c: 'text-orange-400 bg-orange-900/20 border-orange-800' },
