...
INCIDENTS = [
    {
        ...
        "affected_users": json.dumps(["redacted_user", "redacted_user"]),
        ...
        "timeline_json": json.dumps([
            ...
            {"timestamp": (NOW - timedelta(hours=9)).isoformat(), "actor": "redacted_user", "action": "alerted", "detail": "Alert sent to on-call analyst", "type": "notification"},
            ...
            {"timestamp": (NOW - timedelta(hours=5)).isoformat(), "actor": "redacted_user", "action": "contained", "detail": "Blocked source IPs; revoked compromised session tokens", "type": "containment"},
        ]),
        "timeline_count": 4,
    ...
    },
    {
        ...
        "affected_users": json.dumps(["redacted_user"]),
        ...
        "timeline_json": json.dumps([
            ...
            {"timestamp": (NOW - timedelta(hours=2)).isoformat(), "actor": "redacted_user", "action": "isolated", "detail": "Host 192.168.1.45 network-isolated pending forensics", "type": "containment"},
        ]),
        "timeline_count": 3,
    ...
    },
    {
        ...
        "timeline_json": json.dumps([
            ...
            {"timestamp": (NOW - timedelta(days=2, hours=4)).isoformat(), "actor": "redacted_user", "action": "remediated", "detail": "ACL reverted to private; deploy role permissions scoped down", "type": "remediation"},
        ]),
        "timeline_count": 3,
    ...
    },
    {
        ...
        "timeline_json": json.dumps([
            ...
            {"timestamp": (NOW - timedelta(days=3, hours=21)).isoformat(), "actor": "redacted_user", "action": "investigated", "detail": "Confirmed as on-call engineer using service account for emergency patch", "type": "investigation"},
            {"timestamp": (NOW - timedelta(days=3, hours=20)).isoformat(), "actor": "redacted_user", "action": "closed", "detail": "Marked false positive; engineer to use personal account for emergency access going forward", "type": "closure"},
        ]),
        "timeline_count": 3,
        "linked_runs": json.dumps([]),
